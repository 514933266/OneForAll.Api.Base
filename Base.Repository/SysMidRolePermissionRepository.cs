...
namespace Base.Repository
{
    ...
    /// 角色权限
    /// </summary>
    public class SysMidRolePermissionRepository : Repository<SysMidRolePermission>, ISysMidRolePermissionRepository
    {
        ...
        /// <returns>列表</returns>
        public async Task<IEnumerable<SysMidRolePermission>> GetListAsync(Guid roleId)
        {
